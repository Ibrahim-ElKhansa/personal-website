...
export default function HomePage() {
  const skills = ["Javascript", "Typescript", "React", "Next.js", "Node.js", "Express.js", "MongoDB", "PostgreSQL", "Java", "Python", "Machine Learning", "Git", "HTML/CSS"];
